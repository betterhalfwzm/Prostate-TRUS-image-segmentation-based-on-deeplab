...
parser.add_argument('--model_dir', type=str, default='E:/tensorflow-deeplab-v3-plus/model/30225/deeplab_model_superlow_test',
...
parser.add_argument('--data_dir', type=str, default='E:/tensorflow-deeplab-v3-plus/dataset/',
...
parser.add_argument('--pre_trained_model', type=str, default='E:/tensorflow-deeplab-v3-plus/ini_checkpoints/resnet_v2_101/resnet_v2_101.ckpt',
